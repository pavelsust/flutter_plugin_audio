...
public class SwiftFlutterPluginAudioPlugin: NSObject, FlutterPlugin {
    ...
    private static let channelName = "flutter_plugin_audio"
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = SwiftFlutterPluginAudioPlugin(withChannel: channel)
...
//        self.flutterChannel.invokeMethod(self.flutterMethodOnProgressChanged, arguments: timeInMillis)
                ...
                // Disable next/previous track
                commandCenter.nextTrackCommand.addTarget { [unowned self] event in
                    self.flutterChannel.invokeMethod(self.flutterMethodOnNext, arguments: "")
                    return .success
                }
        
                commandCenter.previousTrackCommand.addTarget { [unowned self] event in
                    self.flutterChannel.invokeMethod(self.flutterMethodOnPrevious, arguments: "")
                    return .success
                }
